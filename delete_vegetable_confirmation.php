...
if(isset($_GET['id'])) {
    ...
    // Fetch fruit details
    $sql_fetch = "SELECT `description` FROM `vegetables` WHERE id='$fruit_id'";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="view_uploaded_vegetables.php" class="btn btn-secondary">Cancel</a>
                <a href="delete_vegetables_details.php?id=<?php echo $fruit_id; ?>" class="btn btn-danger">Delete</a>
            </div>
        </div>
    </div>
</div>
