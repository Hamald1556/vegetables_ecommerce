...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT `id`, `image`, `amount`, `description`, `uses`, `category` FROM `fruits` WHERE id = $fruit_id";
...
<div class="container mt-5">
    ...
    <form action="process_update_fruits_details.php?id=<?php echo $fruit_id; ?>" method="POST">
